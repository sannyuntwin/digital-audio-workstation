...
// Mock data
const initialAssets = [
  { id: 1, name: 'Kick_808_Heavy', type: 'audio', format: 'wav', duration: '0.5s', size: '2.1 MB', tags: ['drums', 'kick', '808', 'heavy'], bpm: 120, key: 'C' },
  { id: 2, name: 'Snare_Punchy', type: 'audio', format: 'wav', duration: '0.3s', size: '1.8 MB', tags: ['drums', 'snare', 'punchy'], bpm: 120, key: 'C' },
  { id: 3, name: 'HiHat_Closed_16th', type: 'audio', format: 'wav', duration: '0.1s', size: '0.8 MB', tags: ['drums', 'hihat', 'closed'], bpm: 120, key: 'C' },
  { id: 4, name: 'Bass_Sub_Drop', type: 'audio', format: 'wav', duration: '2.0s', size: '4.2 MB', tags: ['bass', 'sub', 'drop'], bpm: 140, key: 'G' },
  { id: 5, name: 'Synth_Lead_Arpeggio', type: 'audio', format: 'wav', duration: '4.0s', size: '6.8 MB', tags: ['synth', 'lead', 'melody'], bpm: 128, key: 'Am' },
  { id: 6, name: 'Vocal_Chops_Phrase', type: 'audio', format: 'wav', duration: '1.5s', size: '3.2 MB', tags: ['vocal', 'chops', 'phrase'], bpm: 90, key: 'F' },
  { id: 7, name: 'Drum_Loop_HipHop', type: 'audio', format: 'wav', duration: '4.0s', size: '7.1 MB', tags: ['drums', 'loop', 'hiphop'], bpm: 90, key: 'C' },
  { id: 8, name: 'Pad_Atmospheric_Wash', type: 'audio', format: 'wav', duration: '8.0s', size: '12.4 MB', tags: ['pad', 'atmospheric', 'wash'], bpm: 0, key: 'Dm' }
];
    ...
    <div style={modalStyle}>
      ...
      <div style={modalBodyStyle}>
        <div style={sidebarStyle}>
          <div
            style={isDragging ? { ...uploadSectionStyle, borderColor: 'rgba(96, 165, 250, 0.6)', background: 'rgba(30, 64, 175, 0.2)' } : uploadSectionStyle}
            onDrop={handleDrop}
          ...
          {filteredAssets.length === 0 ? (
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '200px', color: '#94a3b8' }}>
              <div>
                ...
                <div style={{ fontSize: '16px', textAlign: 'center' }}>
                  {searchQuery || selectedTags.length > 0 ? 'No samples found matching your filters' : 'No samples uploaded yet. Drag and drop audio files to get started!'}
                </div>
              </div>
            </div>
          ) : (
            <div style={libraryGridStyle}>
              {filteredAssets.map(asset => (
                <div
                  key={asset.id}
                  style={hoveredAsset === asset.id ? assetCardHoverStyle : assetCardStyle}
                  draggable
                  onDragStart={() => console.log('Dragging asset:', asset)}
